...
I18n.translations.nl = {
    ...
    privacy_panel: {
        ...
        subtitle: "Pika requests new connecting SP's to supply some AVG information. If available, you'll find it below. For any missing info, you can contact the supplier.",
    ...
    my_idp: {
        ...
        settings_text_viewer: "This section contains several settings of your institute and the Service Provider(s) provided to Pika by your institute. These settings are used in Pika, for instance in the Where Are You From page.",
