...
public class ActionsServiceImpl implements ActionsService {
  ...
  private void sendAdministrationEmail(Action action) {
    ...
    body.append("Mail applicant: mailto:" + action.getUserEmail() + "?CC=myunified-admin@cybera.ca&SUBJECT=[" + action.getJiraKey().orElse("???") + "]%20" + action.getType().name() + "%20to%20" + action.getSpName() + "&BODY=Beste%20" + action.getUserName() + " \n");
